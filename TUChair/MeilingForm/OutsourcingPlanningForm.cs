...
namespace TUChair
{
    public partial class OutsourcingPlanningForm : TUChair.SearchCommomForm
    {
        public OutsourcingPlanningForm()
        {
            InitializeComponent();
        }

        private void OutsourcingPlanningForm_Load(object sender, EventArgs e)
        {
