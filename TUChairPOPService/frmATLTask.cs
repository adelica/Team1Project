...
namespace TUChair
{
    public partial class frmATLTask : Form
    {
        ...
        private void timSocket_Check_Tick_1(object sender, EventArgs e)
        {
            SocketCheckLive();
        }

        private void timSocket_Ka_Tick_1(object sender, EventArgs e)
        {
            if (KEEP_ARRIVE_COUNT > 10)
            {
                SocketDisConnect();
        ...
        private void frmATLTask_FormClosed_1(object sender, FormClosedEventArgs e)
        {
            //DB접속종료
            if (conn.State == ConnectionState.Open)
            {
        ...
        private void frmATLTask_FormClosing_1(object sender, FormClosingEventArgs e)
        {
            if (!bExit)
            {
                this.Hide();
        ...
        private void frmATLTask_KeyDown_1(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.F12)
            {
                if (this.Height == 435)
        ...
        private void frmATLTask_Load_1(object sender, EventArgs e)
        {
            DBConnection();
